...
#define SET_NAME_TO_TABLE(x) array[CMD_ ## x] = "<" #x ">"; check_sum += CMD_ ## x;
  ...
  // for Kev
  SET_NAME_TO_TABLE(TEST_QEV_EQUAL_R);

  // for numbers
  SET_NAME_TO_TABLE(TEST_NUMBER_R);
  SET_NAME_TO_TABLE(TEST_NUMBER0);
  SET_NAME_TO_TABLE(TEST_NUMBER0_R);

  SET_NAME_TO_TABLE(TEST_NUMBER_EQUAL_R);

  // for char
  SET_NAME_TO_TABLE(TEST_CHAR_R);
  SET_NAME_TO_TABLE(TEST_CHAR0_R);
  SET_NAME_TO_TABLE(TEST_CHAR_EQUAL_R);

  // for symbols
  SET_NAME_TO_TABLE(TEST_SYMBOL);
  SET_NAME_TO_TABLE(TEST_SYMBOL0);
  SET_NAME_TO_TABLE(TEST_SYMBOL_EQUAL_R);

  // for strings
  SET_NAME_TO_TABLE(STRING_CLONE);
  SET_NAME_TO_TABLE(STRING_APPEND);
  SET_NAME_TO_TABLE(TEST_STRING_R);
  SET_NAME_TO_TABLE(TEST_STRING0_R);
  SET_NAME_TO_TABLE(TEST_STRING_EQUAL_R);
  ...
  SET_NAME_TO_TABLE(TEST_PAIR_R);
  SET_NAME_TO_TABLE(TEST_PAIR0_R);
  SET_NAME_TO_TABLE(TEST_NULL_R);
  SET_NAME_TO_TABLE(TEST_NULL0_R);
  CHECK_SUM(TEST_NULL0_R);
